...
ngx_atomic_t   ngx_stat_proxy_request0;
ngx_atomic_t  *ngx_stat_proxy_request = &ngx_stat_proxy_request0;
...
ngx_event_module_init(ngx_cycle_t *cycle)
{
	...
	/*esb ngx_stat_proxy_request*/
	ngx_stat_proxy_request  = (ngx_atomic_t *) (shared + 9 * cl);
    
	/*esb ngx_stat_requests = ngx_stat_requests0*/
    *ngx_stat_requests = ngx_stat_requests0;
    *ngx_stat_proxy_request = ngx_stat_proxy_request0;
#endif
